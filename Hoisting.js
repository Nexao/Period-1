...
function Emil(fname, lname, age){
  this.fname = fname;
  this.lname = lname;
  this.age = age;
}
var di = new Emil('emil', 'klausen', 25); // making an instance of Emil
// adds property to Emil constructor, that can be called on a new Emil object instance
Emil.prototype.showEmil = function(){
  console.log("Emil object has " + this.fname +" " + this.lname+ " " +this.age)
}
di.showEmil();
